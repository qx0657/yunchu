package fun.qianxiao.yunchu.lunzige.widget;
...
import fun.qianxiao.yunchu.lunzige.dialog.HintDialog;
 ...
 */
public class BrowserView extends NestedScrollWebView
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            switch (scheme) {
                ...
                case "mailto":
                    ...
                    // //真机上使用
                    String[] emailReciver = new String[] { url.substring(url.indexOf(":")+1) };
                    // 设置邮件默认地址
